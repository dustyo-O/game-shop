 ...
 * driver package, and the driver is `packages/db/src/client.ts`'s decision,
 * not this module's (Phase 6 weighed a swap to `@neondatabase/serverless` and
 * kept `pg`). The SQLSTATE is the stable part of that contract; the error
 * class is not.
 */
