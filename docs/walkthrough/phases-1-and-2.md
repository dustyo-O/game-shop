> **Superseded.** The single map is now `phases-1-to-3.md`, which re-synthesises this document with Phase 3; this file is kept as the end-of-Phase-2 snapshot and is no longer updated.
